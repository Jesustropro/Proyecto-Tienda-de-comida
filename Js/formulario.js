formCliente = addEventListener("submit", (e) => {    //formulario para obtener informacion del cliente
    ...
    nombreClienteStorage = JSON.stringify(sessionStorage.getItem("Nombre del cliente:"))
    direccionClienteStorage = JSON.stringify(sessionStorage.getItem("Dirección del cliente:")) 
})
nombreClienteStorage
direccionClienteStorage
  function verImagen(){
    n=0;
  ...
  $("#enviarDatos").on("click", () => {           //mostrar datos ingresados en una card
    $("#usuarioModal").append(`   
